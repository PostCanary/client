...
const feature = MARKETING_FEATURES.find((f) => f.slug === "targeted-mail")!;
  ...
  >
    ...
    >
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-start">
        ...
        <div>
          <SectionAccordion id-prefix="targeted-mail" :items="feature.items" />
          <div class="mt-8 flex flex-wrap items-center gap-4">
            ...
            >
              Learn more about Targeted Mail →
            </router-link>
          </div>
        </div>
      </div>
