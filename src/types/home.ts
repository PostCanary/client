...
export const CAMPAIGN_STATUS_LABELS: Record<MailCampaignStatus, string> = {
  ...
  purchasing_records: 'Preparing',
  records_purchased: 'Preparing',
  submitted_to_partner: 'In production',
...
// sequence × 900 × $0.99 = $2,673 (server-owned rate, GET /api/billing/pricing).
...
// ($2,673 for 3 × 900 households × $0.99) plus headroom for one more.
