...
export const tourSteps: TourStepDef[] = [
  {
    ...
    attachTo: { element: "[data-tour=\"topbar\"]", on: "bottom" },
    page: "/app/home",
  },
  {
    id: "nav-links",
    title: "Navigation",
    text: "Use the sidebar to navigate between your Home, Campaigns, Designs, Dashboard, Map, Analysis, Audience, and History pages.",
