...
- **CostBreakdown:** Per-card breakdown: "Card 1: 1,116 × $0.69 = $770". Total at bottom. "Charged per card when it goes to print — not all upfront." Reads pricing from `PRICING` constant + user's subscription tier (default: payPerSend for Round 1).
